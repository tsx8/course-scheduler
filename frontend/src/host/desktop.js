...
const wailsCommandMap = {
    ...
    create_schedule_plan: ({ name }) => ensureWailsApp().CreateSchedulePlan(name),
    copy_schedule_plan: ({ name }) => ensureWailsApp().CopySchedulePlan(name),
    switch_schedule_plan: ({ planId }) => ensureWailsApp().SwitchSchedulePlan(planId),
    rename_schedule_plan: ({ planId, name }) => ensureWailsApp().RenameSchedulePlan(planId, name),
    delete_schedule_plan: ({ planId }) => ensureWailsApp().DeleteSchedulePlan(planId),
